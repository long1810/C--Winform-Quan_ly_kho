...
insert into ChiTietPN (maPN,maHang,giaNhap,soluong)
...
--llllllllllllllll--llllllllllllllll
create proc ncchang1 @m varchar(100)
as
select hang.maHang,hang.soluong 
from nhaCC,ChiTietPN,phieunhap,hang
where nhaCC.maNCC = phieunhap.maNCC and phieunhap.maPN = ChiTietPN.maPN and  ChiTietPN.maHang hang.maHang 
		and nhaCC.maNCC = 'ncc1'
